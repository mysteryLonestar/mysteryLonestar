...
typewriter.typeString('hey there!')
    ...
    .deleteAll()
    .pauseFor(200)
    .typeString("my creative outlet is graphic design & programming")
    .pauseFor(300)
    .deleteAll()
    .pauseFor(200)
    .typeString("coded this website to showcase a bit about me")
    .pauseFor(300)
    .deleteAll()
    .pauseFor(200)
    .typeString("thanks for visiting! scroll down to get started")
    .pauseFor(300)
    .deleteAll()
    .start();
